...
// 2.1-W3 扩表(2026-07-07 拍板):+强受益/受益确定(确定性受益话术)、+有效率/有效信号
// (战绩口径全面迁移到「关系验证/历史同向」,生成侧不得再产出"有效率"话术)。
// 注:负责人清单里的裸「追」未收——会误伤「追踪/追溯/追加投资」等正常词,
// 交易语境的 追高/追涨/追板 已覆盖;「放量下杀/缩量企稳」等复合词由 放量/缩量/企稳/杀跌 单词覆盖。
const BANNED =
  /买入|卖出|建议买|建议卖|推荐买|抄底|满仓|加仓|减仓|清仓|低吸|接飞刀|站岗|目标价|建议参与|短线机会|回调关注|等回调|上车|别急着接|往里冲|追高|追涨|追板|低开|高开|企稳|放量|缩量|破位|补跌|超跌反弹|止跌|杀跌|洗盘|获利盘|兑现盘|错杀|出货|值得多看一眼|开盘盯|盘中盯|逢低|逢高|埋伏|潜伏|梭哈|梭一把|上车|下车|割肉|套牢|接盘|止损|止盈|建仓|补仓|重仓|半仓|空仓|打板|强受益|受益确定|有效率|有效信号/g;
