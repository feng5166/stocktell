        ...
        <div className="mt-6 space-y-6 text-sm leading-relaxed text-gray-700">
          ...
          <Section title="4. 第三方服务">
            ...
            <ul className="mt-1 list-disc space-y-1 pl-5">
              ...
              <li>
                <b>情境式追问(如启用)</b>:你在推理页输入的追问问题、同一追问的近几轮对话,
                以及(为回答“我的自选里哪些相关”)你的自选代码及其产业链关系,会发送给第三方大模型服务用于生成回答;
                <b>不发送邮箱、昵称等身份信息,也不发送成本、仓位或交易记录(我们本就不收集这些)</b>。
                问题与回答在我们的服务器保留 <b>30 天</b>后自动删除;如需提前删除,请通过下方邮箱联系我们。
                追问内容不会进入网页分析系统。
              </li>
              <li>
