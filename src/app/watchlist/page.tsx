  ...
  return (
    <div className="min-h-screen bg-canvas text-ink">
      ...
      <main className="mx-auto max-w-3xl px-4 py-6 sm:px-6">
        ...
        <WatchlistBoard chainMap={chainMap} signalMap={signalMap} names={names} date={date} />
