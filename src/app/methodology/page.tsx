    ...
    <div className="min-h-screen bg-canvas text-ink">
      ...
      <main className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
        ...
        <Section no="03" title="金融数据">
          ...
          <p>
            股票池“资金形态”只把同一收盘日的股价涨跌、主力净额/成交比和当日龙虎榜数据组合成规则信号,
            不叠加前几个交易日,也不使用需要跨日比较的融资余额变化。页面优先使用“建仓 / 洗盘 / 抢筹 / 出货 / 衰竭特征”描述行为形态;
            未命中这五类但同日数据完整时,改用“偏强共振 / 弱势共振 / 资金分歧 / 震荡观望”给出市场状态判断。“待判断”只保留给同日数据缺失的标的,
            <b className="text-gray-700">最高只给中置信,不确认机构真实意图</b>。
            展开个股后会补充近 3 个交易日逐日资金、融资余额变化与龙虎榜作为核验材料,这些补充项不参与当日标签归类。
          </p>
        </Section>
        ...
        <Section no="08" title="更新时间与局限">
          ...
          <ul className="space-y-1.5">
            ...
            <li>· 股票池资金形态:随最新完整资金交易日更新;表头和标签详情标明收盘日期,与盘中行情分开呈现。展开区近 3 日与融资数据同样逐项标日频口径,只供核验。</li>
            <li>
