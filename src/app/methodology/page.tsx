    ...
    <div className="min-h-screen bg-canvas text-ink">
      ...
      <main className="mx-auto max-w-2xl px-4 py-8 sm:px-6">
        ...
        <Section no="03" title="金融数据">
          ...
          <p>
            首页“产业链资金状态”的口径是:
            <b className="text-gray-700">资金强度 = 链内成分股主力净额合计 ÷ 同日成交额合计 × 100%</b>。
            只统计 StockTell 已核定的产业链成分股,不是全市场板块排名;“同向 / 分叉”只比较同日价格与资金方向。
        ...
        <Section no="08" title="更新时间与局限">
          ...
          <ul className="space-y-1.5">
            ...
            <li>· 产业链资金状态:使用 Tushare 收盘日频数据,随最新完整资金交易日更新,不标成盘中实时。</li>
            <li>
