    ...
    <div className="min-h-screen bg-canvas text-ink">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6">
        ...
        <Section title="我们的团队">
          ...
          <p>
            <b>创始人兼 CEO · Mars Chen</b> 毕业于香港科技大学,职业经历丰富:曾任 Lanternfish 首席运营官(用人工智能帮律师事务所降低时间与人力成本),也曾是字节跳动诸多产品的产品经理。近年来,他将大型人工智能模型先后应用于文化研究、心理学,以及如今的<b>金融信息解读 —— 帮普通散户看懂市场</b>。
          </p>
        </Section>
