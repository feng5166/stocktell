...
import { DC_POWER_SEGMENTS, SEMI_EQUIP_SEGMENTS, HUAWEI_SEGMENTS } from "./chain-relations";
...
export const SEGMENT_REGISTRY: Record<string, readonly string[]> = {
  ...
  // 2026-07-30 扩链:华为产业生态链,4 标准环节(enum 在 chain-relations.ts §2.6;一批不接每日推理)
  "huawei-ecosystem": HUAWEI_SEGMENTS,
};

export const KNOWN_SEGMENTS = new Set<string>([...AI_INFRA_SEGMENTS, ...AI_APPLICATION_SEGMENTS, ...DC_POWER_SEGMENTS, ...SEMI_EQUIP_SEGMENTS, ...HUAWEI_SEGMENTS, TRIGGER_SEGMENT]);
