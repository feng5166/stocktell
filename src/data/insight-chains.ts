...
// 华为产业生态链(2026-07-30 扩链,一批)。三条本链特有的诚实性约束,写内容前先读:
// ①华为不上市、不披露财报——每一跳的验证入口天然弱于其它链,能给的只有发布会/伙伴公告/
//   第三方数据,不确定性必须放在明面上;②中芯国际与华为的关系无任何官方披露,只能作
//   「推理假设」表述;③本链暂无美股触发源(华为无上市主体),站内事件原子(隔夜美股异动)
//   覆盖不到本链主事件,日常联动多为情绪性——这一点直接写进 tldr.risk 与 uncertainties。
const HUAWEI_ECOSYSTEM: InsightChain = {
  slug: "huawei-ecosystem",
  title: "华为发新品,为什么会传导到 A 股生态伙伴?",
  updatedAt: "2026-07-30",
  event:
    "华为发布新一代旗舰终端与昇腾算力产品,叠加鸿蒙生态版本升级——即一次「华为新品 / 生态进展」型事件(国内事件源)。",
  eventNote:
    "示例事件:这类「华为发布会 → 生态伙伴联动」反复发生(历代 Mate / 昇腾 / 鸿蒙节点);正式上线会换成当天真实公告。注意:华为不上市,事件本体无行情锚,传导只能通过 A 股伙伴的公告与交付数据核实。",

  tldr: {
    hook: "华为发新品(手机 / 昇腾芯片 / 鸿蒙),这股热度会先传到 A 股的哪几类公司?一眼看懂 👇",
    tiers: [
      { emoji: "🔥", level: "绑定最深", what: "昇腾/鲲鹏算力 · 智选车(问界)", rel: "间接", why: "生态绑定与合作关系公开可查,订单和交付量有公告可核——但收入占比仍待验证" },
      { emoji: "🌡️", level: "生态跟随", what: "鸿蒙 / 欧拉软件生态", rel: "间接", why: "项目制收入跟着华为生态节奏走,普遍占比不高、兑现有时滞" },
      { emoji: "💨", level: "沾光为主", what: "「华为概念」题材 · 无披露的供应链传闻", rel: "情绪映射", why: "没有官方披露或收入验证的关联,多是主题情绪带动" },
    ],
    risk: "华为不上市、不披露财报:这条链的验证入口天然比其它链弱,「华为概念」情绪权重高,涨跌未必对应真实业务变化。当前全部成分为待验证档,分档以合作公开程度为准、不代表受益确认。",
  },

  oneLinerPlain:
    "华为发新品这类事,最先能「对上号」的是绑定公开的伙伴——做昇腾算力整机的、造问界的;鸿蒙 / 欧拉的软件伙伴跟着生态节奏走;至于只沾「华为概念」、拿不出合作披露的,多是情绪带动。",
  oneLiner:
    "与本类「华为新品 / 生态进展」事件关联最明确的是「华为产业生态链」。按「合作公开程度 + 订单可验证性」(非推荐、非收益排序):昇腾/鲲鹏算力伙伴、智选车(合作与交付数据公开)> 鸿蒙/欧拉软件生态(项目制、占比待验证)> 无披露的「华为概念」题材(情绪映射)。核心边界:只收合作关系可公开核实的标的,不做华为概念池;华为不上市,所有传导强度都受披露有限的约束。",
  eventPlain:
    "华为开发布会:新旗舰手机、新的昇腾 AI 算力产品、鸿蒙新版本。华为自己不上市,买不到「华为的股票」,于是市场去找它在 A 股的生态伙伴。",
  storyPlain: [
    "华为发新品,终端热度和生态预期先起来。",
  ...
  heatmap: [
    { segment: "昇腾/鲲鹏算力", plain: "用华为昇腾/鲲鹏芯片做算力整机和方案的伙伴", direction: "升温", intensity: 3, relation: "间接", confidence: "中", hopOrder: 3, reason: "国产算力叙事叠加政企采购,生态绑定公开;订单与算力收入占比待逐票验证" },
    { segment: "智选车/智能汽车", plain: "和华为联合造车、联合卖车的整车厂", direction: "升温", intensity: 3, relation: "间接", confidence: "中", hopOrder: 5, reason: "合作关系与月度交付量公开可核,是本链验证入口最硬的一段;但单一合作依赖度高" },
    { segment: "鸿蒙与软件生态", plain: "给鸿蒙/欧拉做系统、做项目的软件公司", direction: "分化", intensity: 2, relation: "间接", confidence: "低", hopOrder: 4, reason: "生态项目制收入,签约到确认有时滞、占比普遍不高;个股档位以自身披露为准" },
    { segment: "先进制程代工", plain: "国产先进芯片的制造平台", direction: "分化", intensity: 2, relation: "情绪映射", confidence: "低", hopOrder: 6, reason: "「芯片回归」叙事的映射落点;与华为的关系无官方披露,属推理假设,只看产能与大客户结构披露" },
    { segment: "华为概念题材", plain: "缺合作披露与收入验证的「华为概念」", direction: "中性", intensity: 1, relation: "弱", confidence: "低", reason: "只沾「华为」主题、无公开合作或收入验证(供参照的弱项)" },
  ],
  ...
  mainHops: [
    {
      ...
      from: "华为发布新品 / 生态升级",
      to: "终端与生态热度上升",
      plain: "华为发新手机、新算力产品、鸿蒙新版本,整个生态的关注度和预期先起来。",
      logic: "旗舰终端与算力产品发布拉动出货预期与生态活跃度;华为不上市,预期传导只能通过 A 股生态伙伴定价。",
      evidenceType: "发布会 / 官方公告 / 第三方销量与出货数据",
      evidenceExample: "华为官网新闻中心发布信息;第三方机构(如 IDC / Counterpoint)终端出货口径。引具体数字前须回原始来源核对。",
      confidence: "中",
      caveat: "【全链总闸】华为业务数据不公开:发布会热度 → 伙伴订单的传导无法直接验证;若终端销量或生态投入不及预期,整条链的映射强度都要打折。",
      caveatPlain: "华为不发财报——热度到底有没有变成生意,只能等伙伴公司的公告,这是全链最大的不确定。",
    },
    {
      order: 2,
      from: "终端与生态热度",
      to: "伙伴订单与项目预期",
      plain: "热度要变成生意,得落到伙伴身上:昇腾一体机中标、鸿蒙项目签约、问界订单——这些是能查到公告的。",
      logic: "昇腾政企采购、鸿蒙/欧拉项目、智选车定点与交付以公告 / 中标 / 月度数据形式落到上市伙伴,是本链可核实的传导载体。",
      evidenceType: "伙伴公告 / 中标信息 / 交付数据",
      evidenceExample: "上市公司中标 / 签约公告(巨潮 / 上交所);车企月度交付快报。",
      confidence: "中",
    },
  ],
  branchHops: [
    { order: 3, from: "国产算力需求", to: "昇腾/鲲鹏算力伙伴订单↑", plain: "政企要买国产算力,昇腾一体机和行业方案的伙伴先接单。", logic: "信创与政企算力采购以昇腾生态整机为主要落点,伙伴公司的中标公告可验证。", evidenceType: "中标公告 / 政企采购信息", evidenceExample: "伙伴公司昇腾一体机中标 / 框架采购公告。", confidence: "中" },
    { order: 4, from: "鸿蒙生态扩张", to: "软件生态伙伴项目↑", plain: "鸿蒙设备越多,做适配、做项目的软件公司活越多——但从签约到收入有时滞。", logic: "HarmonyOS / OpenHarmony / 欧拉的商业化以项目制落地,伙伴收入占比普遍不高,兑现节奏慢于情绪。", evidenceType: "签约公告 / 年报分部收入", evidenceExample: "伙伴公司年报中鸿蒙 / 华为生态相关业务表述与收入占比。", confidence: "低" },
    { order: 5, from: "智选车新车型 / 销量", to: "问界交付量↑", plain: "新车型上市、卖得好不好,每个月交付快报直接可查——这是本链最硬的验证入口。", logic: "智选车模式下整车厂收入与华为合作深度绑定,交付量是高频可验证指标。", evidenceType: "月度交付快报 / 新车型公告", evidenceExample: "整车厂月度产销快报;新车型上市与定价公告。", confidence: "中" },
    { order: 6, from: "「芯片回归」叙事", to: "先进制程代工关注度↑", plain: "华为手机用上了国产芯片,市场就去找「是谁造的」——但双方从没官方确认过。", logic: "国产先进制程量产平台被市场映射为华为芯片制造落点;无官方披露,属推理假设,只能观察产能利用率与资本开支。", evidenceType: "推理假设(无官方披露)", evidenceExample: "代工厂定期报告中的产能利用率与资本开支;【注意】不存在可引用的华为合作披露。", confidence: "假设", caveat: "该跳无任何官方披露支撑,任何「代工关系」表述都是市场推测;若据此定价,证伪时回撤同样剧烈。", caveatPlain: "这一跳本质是「大家猜的」——猜错了跌回去也快,別把它当成有公告的事实。" },
  ],

  mappingNote:
    "当前关系模型中本链成分【全部为待验证档(candidate)】,待负责人经审阅台逐票终审后才升档(同半导体链一批流程);下表分档为研究框架预判、非终审结论。非推荐、非收益排序,均为 stocks.ts 池内真实标的。池内光模块 / PCB 等华为亦是重要客户的标的(光迅科技 / 深南电路 / 沪电股份 / 华工科技)关系档归 AI 推理链,不在本表重复分档。",
  mappings: [
    { name: "拓维信息", code: "002261", segment: "昇腾/鲲鹏算力", relation: "间接", relationNote: "待终审", reason: "华为昇腾/鲲鹏生态算力整机与行业方案(湘江鲲鹏),生态绑定公开;看昇腾一体机订单、政企中标与算力收入占比", confidence: "低" },
    { name: "赛力斯", code: "601127", segment: "智选车/智能汽车", relation: "间接", relationNote: "待终审", reason: "华为智选车(问界)整车厂,合作与交付数据公开可核;看问界交付量、新车型节奏与汽车业务毛利率;单一合作依赖度高", confidence: "中" },
    { name: "软通动力", code: "301236", segment: "鸿蒙与软件生态", relation: "间接", relationNote: "待终审", reason: "华为多领域合作伙伴(鸿蒙/欧拉/昇腾软件服务);看华为生态项目签约、相关收入占比与毛利结构", confidence: "低" },
    { name: "润和软件", code: "300339", segment: "鸿蒙与软件生态", relation: "间接", relationNote: "待终审", reason: "OpenHarmony 共建单位与发行版厂商;看鸿蒙相关收入占比与兑现节奏,生态参与公开但占比待验证", confidence: "低" },
    { name: "常山北明", code: "000158", segment: "鸿蒙与软件生态", relation: "情绪映射", relationNote: "待终审", reason: "软件集成商,「华为概念」情绪属性强;华为相关真实收入占比与披露有限,需警惕纯主题驱动", confidence: "低" },
    { name: "中芯国际", code: "688981", segment: "先进制程代工", relation: "情绪映射", relationNote: "推理假设", reason: "市场将「芯片回归」叙事映射至国产先进制程平台;与华为的关系无官方披露,属推理假设,只看产能利用率与大客户结构披露", confidence: "低" },
  ],
  ...
  uncertainties: [
    ...
    "全部成分为待验证档(candidate),负责人终审后档位可能上调或剔除;有没有被资金按「华为概念」提前炒过头没有校验。",
  ],
  references: [
    { kind: "常设入口", name: "华为官网新闻中心", url: "https://www.huawei.com/cn/news", type: "发布会 / 官方公告", supports: "主线第1步(新品与生态发布)", note: "华为新品、昇腾与鸿蒙生态进展的官方口径,本链事件源头", targets: [{ type: "hop", id: "1" }] },
    { kind: "常设入口", name: "巨潮资讯网", url: "http://www.cninfo.com.cn", type: "A 股映射核验(深市)", supports: "拓维信息 / 软通动力 / 润和软件 / 常山北明的公告与收入核验", note: "中标 / 签约公告与定期报告原文,分档验证以此为准" },
    { kind: "常设入口", name: "上交所公告检索", url: "http://www.sse.com.cn/disclosure/listedinfo/announcement/", type: "A 股映射核验(沪市/科创板)", supports: "赛力斯的交付与合作公告、中芯国际的产能与资本开支披露", note: "按代码 601127 / 688981 检索;注意中芯国际不存在华为合作披露" },
  ],
  disclaimer:
    "本内容为华为产业生态链的关联梳理,基于公开、可核实的合作关系与公认的产业逻辑。当前页面包含常设官方核验入口;演示事件仍为样板事件,正式上线时会替换为当天真实事件,并为每一跳补充具体来源、发布时间、引用字段和更新时间。文中所有关系均为「关联 / 映射 / 受影响」,属非确认因果关系、仅统计非预测,不构成任何投资建议、不含买卖指令、目标价或涨跌预测。核心边界:只收合作关系可公开核实的标的,不做华为概念池;华为为非上市公司、不披露财报,本链所有传导强度都受披露有限约束,其中先进制程代工一档为无官方披露的推理假设。本工具不提供证券投资咨询服务,所列个股仅为产业链关联的说明性示例,不构成任何推荐;个股波动风险自负。",
};
...
export const INSIGHT_CHAINS: Record<string, InsightChain> = {
  ...
  [HUAWEI_ECOSYSTEM.slug]: HUAWEI_ECOSYSTEM,
};
