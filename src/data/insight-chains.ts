...
const DATACENTER_POWER: InsightChain = {
  ...
  tldr: {
    ...
    tiers: [
      ...
      { emoji: "🌡️", level: "跟着热", what: "液冷二线 · 储能 · 输配电/变压器", rel: "间接", why: "功率上来了,液冷配套、储能备电、电网侧跟着忙" },
  ...
  oneLinerPlain:
    "这种「AI 数据中心扩张 + 单机柜功率飙升」的事,最先带动的是给机房稳定供电的「供配电 / UPS / HVDC」和给它降温的「数据中心专用温控 / 液冷」;其次是液冷二线、储能和输配电;发电、核电这些离数据中心订单最远,更多是「算力耗电」的情绪带动。",
  oneLiner:
    "与本类「数据中心扩张 / 功率密度提升」事件业务暴露最明确的是「数据中心供配电与能效基础设施链」。按「业务暴露 + 订单可验证性」(非推荐、非收益排序):数据中心供配电 / UPS / HVDC ≈ 数据中心专用温控 / 液冷(直接业务暴露) > 液冷二线 / 储能 / 输配电(间接) > 发电 / 核电(承接「算力耗电」宏大叙事,传导链最长、映射最弱,本质是能源股)。核心边界:该链核心是数据中心的供配电与散热基础设施,非泛电力行业;缺数据中心订单验证的电力题材不计入直接。",
  eventPlain:
  ...
  whyThisEvent:
    "本链差异化不在「画一张电力设备图」,而在这一个事件的具体 delta 如何改变各环节排序:本次核心是「数据中心功率密度提升 + capex 上修」→ 权重压在数据中心侧的供配电 / UPS / 温控 / 液冷。若换成「电网新能源消纳」事件,重心转向储能 / 特高压 / 电网数字化,与数据中心链是两条链。红线:若「数据中心扩张」与「电网新能源」两类事件产出同一张热力图,即为按类别检索预制图谱,产物不成立。",
  ...
  heatmap: [
    ...
    { segment: "液冷二线 / CDU / 冷板", plain: "液冷里的冷板、CDU、管路等配套", direction: "升温", intensity: 4, relation: "间接", confidence: "中", hopOrder: 4, reason: "液冷渗透带动,但内部竞争与数据中心收入占比不一,订单节奏待验证" },
  ...
  mappingNote:
    "按业务暴露 + 订单可验证性分级(非推荐、非收益排序);均为 stocks.ts 池内真实标的。核心边界:数据中心供配电与散热为直接,电网 / 储能为间接,发电 / 核电为情绪映射。",
  mappings: [
    { name: "盛弘股份", code: "300693", segment: "数据中心供配电 / HVDC", relation: "直接", reason: "数据中心 HVDC / 电力电子,对标 Vertiv 电力侧,数据中心供配电业务暴露明确", confidence: "中" },
    { name: "科士达", code: "002518", segment: "数据中心 UPS / 供配电", relation: "直接", reason: "数据中心 UPS / 供配电 + 储能,业务与数据中心供电直接相关", confidence: "中" },
    { name: "英维克", code: "002837", segment: "数据中心液冷 / 温控", relation: "直接", reason: "数据中心液冷 / 温控龙头,功率密度提升下液冷渗透的直接受益环节", confidence: "中" },
    { name: "申菱环境", code: "301018", segment: "数据中心专用温控", relation: "直接", reason: "数据中心专用空调和液冷系统,业务直接绑定数据中心散热", confidence: "中" },
    { name: "金盘科技", code: "688676", segment: "变压器 / 数字化电力", relation: "直接", reason: "干式变压器 + 数字化电力设备,数据中心配电环节业务暴露明确", confidence: "中" },
    { name: "欧陆通", code: "300870", segment: "服务器电源", relation: "直接", reason: "服务器电源,直接给 AI 服务器供电,绑定服务器出货", confidence: "中" },
    { name: "高澜股份", code: "300499", segment: "液冷", relation: "间接", reason: "纯水冷却 / 液冷,液冷渗透带动,但订单节奏与竞争待验证", confidence: "中" },
    { name: "同飞股份", code: "300990", segment: "液冷 / CDU", relation: "间接", reason: "冷板及浸没液冷、CDU,液冷二线,受渗透带动、数据中心占比待验证", confidence: "中" },
    { name: "曙光数创", code: "920808", segment: "浸没液冷", relation: "间接", reason: "浸没与冷板液冷基础设施,数据中心液冷方案商,业务暴露较明确但盘子 / 订单待验证", confidence: "中" },
    { name: "飞荣达", code: "300602", segment: "液冷板 / CDU", relation: "间接", reason: "液冷板、CDU 及热管理器件,液冷零部件,数据中心收入占比待验证", confidence: "低" },
    { name: "科华数据", code: "002335", segment: "数据中心 / 储能温控", relation: "间接", reason: "数据中心 + 储能温控,受数据中心扩容带动,但业务多元", confidence: "中" },
  ...
  uncertainties: [
    ...
    "液冷二线(高澜 / 同飞 / 飞荣达 / 曙光数创)与麦格米特的数据中心收入占比,需以年报 / 公告披露为准,别把「有液冷 / 电源业务」等同于「数据中心订单」。",
