...
const HUAWEI_ECOSYSTEM: InsightChain = {
  ...
  tldr: {
    ...
    tiers: [
      { emoji: "🔥", level: "绑定最深", what: "智选车(问界)", rel: "直接", why: "联合设计/联合销售关系公开,每月交付快报直接可查——本链验证入口最硬的一段" },
      { emoji: "🌡️", level: "生态跟随", what: "昇腾/鲲鹏算力 · 鸿蒙/欧拉软件", rel: "间接", why: "生态绑定与中标公告公开,但华为相关收入占比不纯、兑现有时滞" },
      { emoji: "💨", level: "沾光为主", what: "「华为概念」题材 · 无披露的供应链传闻", rel: "情绪映射", why: "没有官方披露或收入验证的关联,多是主题情绪带动" },
    ],
    risk: "华为不上市、不披露财报:这条链的验证入口天然比其它链弱,「华为概念」情绪权重高,涨跌未必对应真实业务变化。分档以合作公开程度为准、不代表受益确认。",
  },

  oneLinerPlain:
    "华为发新品这类事,最先能「对上号」的是绑定公开的伙伴——做昇腾算力整机的、造问界的;鸿蒙 / 欧拉的软件伙伴跟着生态节奏走;至于只沾「华为概念」、拿不出合作披露的,多是情绪带动。",
  oneLiner:
    "与本类「华为新品 / 生态进展」事件关联最明确的是「华为产业生态链」。按「合作公开程度 + 订单可验证性」(非推荐、非收益排序):智选车(合作与月度交付数据公开,直接映射)> 昇腾/鲲鹏算力、鸿蒙/欧拉软件生态(合作公开但收入占比不纯,间接映射)> 无披露的「华为概念」题材(情绪映射)。核心边界:只收合作关系可公开核实的标的,不做华为概念池;华为不上市,所有传导强度都受披露有限的约束。",
  eventPlain:
  ...
  heatmap: [
    ...
    { segment: "智选车/智能汽车", plain: "和华为联合造车、联合卖车的整车厂", direction: "升温", intensity: 4, relation: "直接", confidence: "中", hopOrder: 5, reason: "合作关系与月度交付量公开可核,是本链验证入口最硬的一段;但单一合作依赖度高" },
  ...
  mappings: [
    { name: "赛力斯", code: "601127", segment: "智选车/智能汽车", relation: "直接", reason: "华为智选车(问界)整车厂,联合设计/联合销售关系公开、月度交付快报高频可验证;看问界交付量、新车型节奏与汽车业务毛利率;单一合作依赖度高", confidence: "中" },
    { name: "拓维信息", code: "002261", segment: "昇腾/鲲鹏算力", relation: "间接", reason: "华为昇腾/鲲鹏生态算力整机与行业方案(湘江鲲鹏),生态绑定与中标公告公开;算力收入占比不纯待核;看昇腾一体机订单、政企中标与算力收入占比", confidence: "中" },
    { name: "软通动力", code: "301236", segment: "鸿蒙与软件生态", relation: "间接", reason: "华为多领域合作伙伴(鸿蒙/欧拉/昇腾软件服务);看华为生态项目签约、相关收入占比与毛利结构,项目制兑现有时滞", confidence: "低" },
    { name: "润和软件", code: "300339", segment: "鸿蒙与软件生态", relation: "间接", reason: "OpenHarmony 共建单位与发行版厂商;看鸿蒙相关收入占比与兑现节奏,生态参与公开但占比小", confidence: "低" },
    { name: "常山北明", code: "000158", segment: "鸿蒙与软件生态", relation: "情绪映射", reason: "软件集成商,「华为概念」情绪属性强;华为相关真实收入占比与披露有限,无明确业务暴露入口", confidence: "低" },
    { name: "中芯国际", code: "688981", segment: "先进制程代工", relation: "情绪映射", relationNote: "推理假设", reason: "市场将「芯片回归」叙事映射至国产先进制程平台;与华为的关系无官方披露,属推理假设,只看产能利用率与大客户结构披露;出现官方披露前不升档", confidence: "低" },
  ],
