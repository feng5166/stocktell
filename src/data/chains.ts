...
export const CHAINS: Record<string, ChainConfig> = {
  ai: {
    ...
    segments: [
      ...
      { name: "先进封装/封测", plain: "把芯片和内存「叠装」并完成封装测试的制造环节", sectors: ["封装测试/代工"], defaultRelation: "间接映射", verifyTemplate: ["2.5D/先进封装收入", "客户导入", "产能利用率/毛利率"] },
      { name: "先进封装材料", plain: "先进封装用的塑封料、填充/粉体和电镀化学品", sectors: ["先进封装材料"], defaultRelation: "间接映射", verifyTemplate: ["先进封装材料收入", "封测客户验证", "产能与毛利率"] },
