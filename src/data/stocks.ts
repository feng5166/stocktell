...
const STOCKS_BASE: StockBase[] = [
  ...
  // ===== A股 =====
  { code: "688041", name: "海光信息", market: "A股", position: "上游", sector: "AI芯片/GPU", positioning: "国产 CPU/DCU,英伟达在华替代", observation: "国产算力禁令下最直接受益,估值偏高", status: "今日有新消息", relationTypes: ["A股映射", "主题关联"], relations: ["NVDA", "AMD", "INTC"] },
  ...
  { code: "600183", name: "生益科技", market: "A股", position: "上游", sector: "PCB/CCL", positioning: "覆铜板龙头", observation: "高频高速材料受益", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "688008", name: "澜起科技", market: "A股", position: "上游", sector: "存储/HBM", positioning: "内存接口芯片全球龙头", observation: "DDR5/HBM 配套受益", status: "今日有新消息", relationTypes: ["产业链"], relations: ["MU"] },
  ...
  { code: "603893", name: "瑞芯微", market: "A股", position: "上游", sector: "端侧AI/SoC", positioning: "端侧 AI SoC 龙头", observation: "AIoT 与边缘算力受益", status: "今日有新消息", relationTypes: ["主题关联"], relations: ["ARM"] },
  ...
  { code: "002475", name: "立讯精密", market: "A股", position: "中游", sector: "服务器/算力", positioning: "连接器+算力组件", observation: "高速铜连接受益", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "002851", name: "麦格米特", market: "A股", position: "中游", sector: "电源/HVDC", positioning: "电源+电控平台", observation: "服务器电源受益算力", status: "行情覆盖", relationTypes: ["电力映射"], relations: [] },
  ...
  { code: "600050", name: "中国联通", market: "A股", position: "下游", sector: "数据中心/IDC", positioning: "运营商云+IDC", observation: "算力网络建设受益", status: "长期观察", relationTypes: ["资本开支"], relations: [] },
  ...
  { code: "002049", name: "紫光国微", market: "A股", position: "上游", sector: "FPGA/特种芯片", positioning: "特种芯片+FPGA", observation: "国产可编程逻辑受益", status: "长期观察", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "688535", name: "华海诚科", market: "A股", position: "上游", sector: "半导体材料", positioning: "环氧塑封料、底部填充等先进封装材料", observation: "HBM/Chiplet封装材料收入、客户验证、毛利率、145附近支撑和138止损", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "688300", name: "联瑞新材", market: "A股", position: "上游", sector: "半导体材料", positioning: "球形硅微粉、氧化铝等功能性粉体", observation: "高频高速CCL和先进封装粉体收入、225-235回踩、产能和价格", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "688268", name: "华特气体", market: "A股", position: "上游", sector: "半导体材料", positioning: "光刻、蚀刻、成膜和掺杂用高纯电子特气", observation: "高端特气认证、225-230回踩、价格和盈利恢复", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  { code: "688106", name: "金宏气体", market: "A股", position: "上游", sector: "半导体材料", positioning: "大宗气体、电子特气和现场制气服务", observation: "电子特气收入占比、客户认证、价格、31-32支撑和现金流", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "600667", name: "太极实业", market: "A股", position: "中游", sector: "存储/HBM", positioning: "海力士无锡封测合资,HBM后道受益", observation: "海力士稼动率、HBM后道封测、工程业务", status: "行情覆盖", relationTypes: ["A股映射", "产业链"], relations: ["MU", "香农芯创"] },
