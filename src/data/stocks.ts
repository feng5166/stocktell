...
const RETAIL_TAKES: Record<string, string> = {
  ...
  "300502": "光模块第二极,弹性比龙头更大。海外订单占比高,美股科技股大跌时它常被情绪带跌,是否「错杀」要看订单与出货有没有变化。",
  ...
  "300474": "A股唯一纯国产 GPU 标的,题材稀缺、弹性大。但业绩兑现慢、估值高,属高波动情绪票,涨跌主要反映题材热度而非业绩变化。",
  "603019": "国产算力整机龙头,海光的'大哥'。跟国产替代和招标节奏走,比纯题材票多一层业绩支撑,但盘子大、爆发力不如小盘妖票。",
  "600584": "全球封测一哥,AI 芯片要量产都绕不开它。产业链里偏稳的龙头,跟着景气走,不是暴涨暴跌的妖票。",
  "688820": "做晶圆级先进封装,2.5D/多芯片集成是它与 AI 算力最相关的业务入口。新上市、历史行情较短,重点核验先进封装收入、客户结构、产能利用率和毛利率,不因题材直接推断订单。",
  "688825": "国产 DRAM 一体化制造商,DDR5 已覆盖服务器场景,是存储链里少有的芯片原厂。它不等于已量产 HBM;判断 AI 相关性要看服务器内存收入、客户结构以及 HBM 研发和量产披露。",
...
export const TIER: Record<string, "龙头" | "二线"> = {
  ...
  "688362": "二线", "688702": "二线", "688825": "龙头", "688981": "龙头", "000977": "龙头",
...
const STOCKS_BASE: StockBase[] = [
  ...
  { code: "688825", name: "长鑫科技", market: "A股", position: "上游", sector: "存储/HBM", positioning: "国产 DRAM 设计制造一体化厂商,DDR5 覆盖服务器", observation: "服务器 DDR5 收入与客户结构、产能利用率、毛利率及 HBM 研发/量产披露", status: "行情覆盖", relationTypes: ["A股映射", "产业链"], relations: ["MU", "澜起科技", "兆易创新"] },
  ...
  { code: "688535", name: "华海诚科", market: "A股", position: "上游", sector: "先进封装材料", positioning: "环氧塑封料、底部填充等先进封装材料", observation: "HBM/Chiplet封装材料收入、客户验证、毛利率", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "688300", name: "联瑞新材", market: "A股", position: "上游", sector: "先进封装材料", positioning: "球形硅微粉、氧化铝等功能性粉体", observation: "高频高速CCL和先进封装粉体收入、产能和价格", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "300236", name: "上海新阳", market: "A股", position: "上游", sector: "先进封装材料", positioning: "电镀液、清洗液、光刻胶配套和晶圆制造化学品", observation: "湿化学品和电镀液订单、先进封装应用、回踩承接和估值", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "688820", name: "盛合晶微", market: "A股", position: "上游", sector: "封装测试/代工", positioning: "晶圆级先进封装与2.5D多芯片集成平台", observation: "2.5D/多芯片集成业务收入、客户结构、产能利用率和毛利率", status: "行情覆盖", relationTypes: ["A股映射", "产业链"], relations: ["长电科技", "通富微电", "华天科技"] },
