...
const RETAIL_TAKES: Record<string, string> = {
  ...
  // 手写修正(2026-07-30):生成版把智选车说成"代工厂",与关系口径不符(联合设计/联合销售)
  "601127": "华为智选车(问界)的整车厂,跟华为是联合设计、联合卖车的深度绑定。每月交付快报直接可查,是华为链里最能用数字说话的一只;风险是命系问界一个系列,车型周期一转弱波动就大。",
  "688041": "国产算力禁令下关联度最高的标的,情绪来时弹性大。但 PE 高、波动剧烈,涨跌更多由情绪驱动,真实受益要看订单与生态兑现。",
  "688256": "纯国产 AI 芯片标的,题材一来涨得猛、跌得也狠,波动主要由情绪驱动。真实进展要看订单放量和大客户验证,而不是消息热度。",
  "300308": "光模块全球龙头,跟英伟达/海外云厂资本开支高度绑定。海外财报超预期时它最先反应,已连涨时要分清是订单兑现还是纯情绪接力。",
  "300502": "光模块第二极,弹性比龙头更大。海外订单占比高,美股科技股大跌时它常被情绪带跌,究竟是情绪冲击还是基本面变化,要看订单与出货量数据。",
  "601138": "AI 服务器代工龙头,出货量是算力景气度的体温计。盘子大、波动相对小,景气验证直接看每季出货量和大客户订单。",
  "000977": "国产 AI 服务器龙头,与国产算力放量直接相关。跟着政策和大厂招标节奏走,消息驱动明显。",
  "002837": "液冷温控龙头,算力越堆越多、散热越刚需,逻辑顺。属于二线弹性,跟随主线情绪,单独走强时先看有没有订单层面的新验证。",
  "688981": "国产代工龙头,更多是国产替代的长期叙事而非短期业绩弹性。跟踪重点是先进制程产能利用率和大客户结构,节奏以年计。",
  "002230": "国产大模型代表,题材属性强、业绩兑现慢,涨跌更多反映 AI 应用主题的情绪温度。真正要盯的是星火大模型的商业化收入和大项目落地。",
  "300474": "A股唯一纯国产 GPU 标的,题材稀缺、弹性大。但业绩兑现慢、估值高,波动主要由题材情绪驱动,涨跌反映的是热度而非业绩变化。",
  "603019": "国产算力整机龙头,海光的'大哥'。跟国产替代和招标节奏走,比纯题材标的多一层业绩支撑;盘子大,波动比小盘题材股温和。",
  "600584": "全球封测一哥,AI 芯片要量产都绕不开它。产业链里偏稳的龙头,跟着景气周期走,验证看先进封装稼动率和订单。",
  "002130": "铜连接人气最高的标的,直接绑英伟达 GB200 铜背板。题材一来涨得猛,但游资拥挤、波动极大,涨幅和订单兑现之间的差距要用供货公告验证。",
  "300679": "高速铜缆/连接器,对标海外 CRDO,吃 GB200 放量。弹性大但跟主线情绪走,供货规模确认前波动多是情绪驱动。",
  "688702": "A股唯一的国产交换芯片,对标博通。国产替代叙事强、业绩兑现还早,波动跟着信创和网络招标消息走,验证看芯片放量和大客户导入。",
  ...
  "300418": "国产大模型+AIGC 应用,题材属性强、业绩兑现慢,涨跌更多反映 AI 应用主题的情绪温度。要盯的是天工大模型和 AIGC 产品的真实商业化收入。",
  "002415": "AI 落地的大白马,机构持仓集中。盘子大、波动相对稳,业绩底盘厚;AI 含量要看大模型行业落地和海外业务的实际收入。",
  // —— 修正生成版里被截断/写死股价的招牌文案(手写优先,不被重新生成覆盖)——
  "600206": "做芯片上游的靶材和稀贵金属材料,二线弹性标的。AI 情绪来时弹性不小,但本质是材料生意,长期还是看客户验证和资源价格。",
  "000657": "钨资源和硬质合金龙头,沾 AI 是因为电路板钻头等下游要用钨。本质是资源材料生意,跟着钨价和下游需求走,与 AI 主线只是间接关联。",
  "300054": "给芯片厂抛光晶圆用的耗材商(抛光垫、抛光液),国产替代有空间,二线弹性标的。关键看耗材放量和利润能不能兑现,短期波动说明不了问题。",
  ...
  LNG: "美国最大的液化天然气出口商,沾 AI 是因为数据中心耗电猛、天然气发电需求被带起来。但它本质是能源股,价格看长期供货合同和欧亚需求,跟 AI 只是间接关系。",
  ...
  PL: "美国遥感卫星数据商,算 AI 产业链里的数据层。目前更偏题材股,收入靠政府合同续签和商业拓展,业绩还没兑现,当前更多是题材演绎,适合观察验证。",
};
...
const STOCKS_BASE: StockBase[] = [
  ...
  { code: "000657", name: "中钨高新", market: "A股", position: "上游", sector: "战略材料/资源", positioning: "钨矿、粉末、硬质合金、PCB微钻和高端刀具", observation: "钨价、PCB刀具、硬质合金利润率和现金流", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "688019", name: "安集科技", market: "A股", position: "上游", sector: "半导体设备", positioning: "CMP抛光液、湿电子化学品、电镀液和添加剂", observation: "CMP和先进封装耗材放量、先进制程客户验证进展", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "002409", name: "雅克科技", market: "A股", position: "上游", sector: "半导体材料", positioning: "前驱体、光刻胶配套材料、LNG保温和电子材料平台", observation: "半导体材料收入、存储客户景气、前驱体放量和客户验证进度", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  { code: "600206", name: "有研新材", market: "A股", position: "上游", sector: "半导体材料", positioning: "靶材、稀贵金属和半导体功能材料", observation: "靶材和稀贵材料盈利、客户验证和资源价格", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  { code: "300346", name: "南大光电", market: "A股", position: "上游", sector: "半导体材料", positioning: "前驱体、电子特气、光刻胶及配套材料", observation: "ArF光刻胶验证、前驱体和特气收入结构", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  { code: "300236", name: "上海新阳", market: "A股", position: "上游", sector: "半导体材料", positioning: "电镀液、清洗液、光刻胶配套和晶圆制造化学品", observation: "湿化学品和电镀液订单、先进封装应用和估值", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  { code: "300408", name: "三环集团", market: "A股", position: "上游", sector: "半导体材料", positioning: "MLCC陶瓷材料、陶瓷基板和电子陶瓷元件", observation: "AI服务器MLCC需求、陶瓷基板收入占比变化", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  ...
  { code: "603256", name: "宏和科技", market: "A股", position: "上游", sector: "PCB/CCL", positioning: "高端电子级玻纤布和低介电电子布", observation: "低介电电子布价格、产能、客户验证和估值风险", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
  { code: "605589", name: "圣泉集团", market: "A股", position: "上游", sector: "PCB/CCL", positioning: "酚醛树脂、特种环氧树脂和电子材料", observation: "电子树脂收入、AI服务器CCL映射和价格", status: "行情覆盖", relationTypes: ["产业链"], relations: [] },
