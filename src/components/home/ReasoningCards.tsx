  ...
  return (
    <div ref={ref}>
      <Link
        ...
        onClick={onClick}
        className="block rounded-xl border-t-2 border-violet-400 bg-white p-4 shadow-sm transition-shadow hover:shadow sm:p-5"
      >
        ...
        {c.humanSummary && c.trigger && (
          <p className="mt-3 border-t border-gray-100 pt-2.5 text-sm leading-relaxed text-gray-700">
            {c.humanSummary}
          </p>
        )}
  ...
  return (
    <div ref={ref}>
      <Link
        href={`/insight/${c.insightSlug}`}
        onClick={onClick}
        className="block h-full rounded-xl bg-white p-4 shadow-sm ring-1 ring-gray-100 transition-shadow hover:shadow"
      >
