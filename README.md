...
> **完整定稿:[`docs/PRODUCT-CORE.md`](docs/PRODUCT-CORE.md) —— 讨论问题、开发任何新功能前,先对照那份检查清单。**

> **StockTell 不是股票软件、不是新闻聚合,是 AI-native 的「产业理解工具」**(长期愿景 = AI 时代的 Bloomberg)。
> **产品公式 = 事件输入 × 产业链图谱 × 多跳推理 × 资产映射 × 证据验证**:从一件全球大事,推演出它会影响中国哪些产业链和股票,并给出每一跳依据。**第一条铁律:绝不做新闻聚合。**
